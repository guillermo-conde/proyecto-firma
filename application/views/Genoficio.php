							...
							<div class="row justify-content-center features">
								<div class="col-sm-6 col-md-5 col-lg-4 item">
									<div class="box"><i class="fa fa-clock-o icon" style="color: rgb(238,20,20);"></i>
										<h3 class="name"></h3><a class="btn btn-primary" role="button" href="/Historial%20de%20pagos.html" style="background-color: rgb(122,126,130);"><strong>Historial de pagos</strong><br></a></div>
								</div>
								<div class="col-sm-6 col-md-5 col-lg-4 item">
									<div class="box"><i class="fa fa-list-alt icon" style="color: rgb(238,20,20);"></i>
										<h1></h1><a class="btn btn-primary" role="button" href="/Documentos%20generales.html" style="background-color: rgb(128,134,140);"><strong>Documentos generales</strong><br></a></div>
								</div>
							</div>
							<!-- End: Features -->
						</div>
